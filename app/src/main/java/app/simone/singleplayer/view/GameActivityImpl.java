 ...
 **/
public abstract class GameActivityImpl extends FullscreenBaseGameActivity implements GameActivity {
    ...
    private Handler vHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.PLAYER_TURN:
                    Utilities.getActorByName(Constants.PATH_ACTOR + Constants.GAMEVIEW_ACTOR_NAME, App.getInstance().getActorSystem())
                            .tell(new GuessColorMsg(SimonColorImpl.fromInt(msg.arg1)), ActorRef.noSender());
                    break;
            }
        }
    };
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (buttons.size() == 0) {
            buttons.add(initColorButton(SimonColorImpl.GREEN));
            buttons.add(initColorButton(SimonColorImpl.RED));
            buttons.add(initColorButton(SimonColorImpl.YELLOW));
            buttons.add(initColorButton(SimonColorImpl.BLUE));
        }
    }
    ...
    public void onBackPressed() {
        ...
        if (!tapToBegin) {
            AlertDialog alertDialog = new AlertDialog.Builder(GameActivityImpl.this).create();
            ...
            alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            finish();
                            ScoreHelper.sendResultToLeaderboard(chosenMode, finalScore);
                            GameActivityImpl.super.onBackPressed();
